      ...
      <div className="parent">
        <div className="child child-1">
          <button className="button btn-1">
            <svg
              ...
              viewBox="0 0 512 512"
            >
              <a href="https://x.com/EtherealMacroni" target="blank">
                <path
        ...
        <div className="child child-2">
          <button className="button btn-2">
            ...
            >
              <a
                href="https://www.instagram.com/ethereal.macroni"
                target="blank"
              >
                {" "}
                <path
        ...
        <div className="child child-3">
          <button className="button btn-3">
            <svg
              ...
              viewBox="0 0 496 512"
            >
              <a href="https://github.com/saadakhtr29" target="blank">
                {" "}
                <path
        ...
        <div className="child child-4">
          <button className="button btn-4">
            ...
            >
              <a
                href="https://www.linkedin.com/in/saad-akhtar29"
                target="blank"
              >
                <path
